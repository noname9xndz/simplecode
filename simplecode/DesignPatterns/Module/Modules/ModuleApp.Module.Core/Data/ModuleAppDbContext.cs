...
namespace ModuleApp.Module.Core.Data
{
    ...
    {
        public ModuleAppDbContext(DbContextOptions options) : base(options)
        {
        }
        ...
        private void ValidateEntities()
        {
            ...
            foreach (var entity in modifiedEntries)
            {
                if (entity.Entity is ValidatableObject validatableObject)
                {
                    ...
                    {
                        throw new ModuleApp.Infrastructure.Common.ValidationException(entity.Entity.GetType(), validationResults);
                    }
                }
            }
        }
