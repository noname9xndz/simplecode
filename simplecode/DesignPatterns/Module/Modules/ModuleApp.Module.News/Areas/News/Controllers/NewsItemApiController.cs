...
using ModuleApp.Infrastructure.Web.SmartTable;
using ModuleApp.Module.Core.Models.MVC;
using ModuleApp.Module.Core.Services.Interfaces;
using ModuleApp.Module.News.Areas.News.ViewModels;
...
namespace SimplCommerce.Module.News.Areas.News.Controllers
{
    ...
    public class NewsItemApiController : Controller
    {
        ...
        public NewsItemApiController(IRepository<NewsItem> newsItemRepository, INewsItemService newsItemService, IMediaService mediaService)
        {
        ...
        public async Task<IActionResult> Post(NewsItemForm model)
        {
            ...
            var currentUser = "to do get user"; //await _workContext.GetCurrentUser();
