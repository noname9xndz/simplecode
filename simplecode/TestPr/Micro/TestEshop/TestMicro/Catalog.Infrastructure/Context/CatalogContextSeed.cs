...
namespace Catalog.Infrastructure.Context
{
    ...
    {
        public async Task SeedAsync(CatalogDbContext dbContext, IWebHostEnvironment env, IOptions<CatalogSettings> settings, ILogger<CatalogContextSeed> logger)
        {
            ...
            await policy.ExecuteAsync(async () =>
            {
                ...
                {
                    await dbContext.CatalogBrands.AddRangeAsync(useCustomizationData
                ...
                {
                    await dbContext.CatalogTypes.AddRangeAsync(useCustomizationData
                ...
                {
                    await dbContext.CatalogItems.AddRangeAsync(useCustomizationData
                        ? GetCatalogItemsFromFile(contentRootPath, dbContext, logger)
        ...
        private CatalogBrand CreateCatalogBrand(string brand)
        {
            ...
            {
                throw new System.Exception("catalog Brand Name is empty");
            }
        ...
        private CatalogType CreateCatalogType(string type)
        {
            ...
            {
                throw new System.Exception("catalog Type Name is empty");
            }
        ...
        private IEnumerable<CatalogItem> GetCatalogItemsFromFile(string contentRootPath, CatalogDbContext dbContext, ILogger<CatalogContextSeed> logger)
        {
            string csvFileCatalogItems = Path.Combine(contentRootPath, "SetupData", "CatalogItems.csv");
            ...
            var catalogTypeIdLookup = dbContext.CatalogTypes.ToDictionary(ct => ct.Type, ct => ct.Id);
            var catalogBrandIdLookup = dbContext.CatalogBrands.ToDictionary(ct => ct.Brand, ct => ct.Id);
        ...
        private CatalogItem CreateCatalogItem(string[] column, string[] headers, Dictionary<String, int> catalogTypeIdLookup, Dictionary<String, int> catalogBrandIdLookup)
        {
            ...
            {
                throw new System.Exception($"column count '{column.Count()}' not the same as headers count'{headers.Count()}'");
            }
            ...
            {
                throw new System.Exception($"type={catalogTypeName} does not exist in catalogTypes");
            }
            ...
            {
                throw new System.Exception($"price={priceString}is not a valid decimal number");
            }
            ...
            if (availableStockIndex != -1)
            {
                ...
                if (!String.IsNullOrEmpty(availableStockString))
                {
                    ...
                    {
                        throw new System.Exception($"availableStock={availableStockString} is not a valid integer");
                    }
                }
            }
            ...
            if (restockThresholdIndex != -1)
            {
                ...
                if (!String.IsNullOrEmpty(restockThresholdString))
                {
                    ...
                    {
                        throw new System.Exception($"restockThreshold={restockThreshold} is not a valid integer");
                    }
                }
            }
            ...
            if (maxStockThresholdIndex != -1)
            {
                ...
                if (!String.IsNullOrEmpty(maxStockThresholdString))
                {
                    ...
                    {
                        throw new System.Exception($"maxStockThreshold={maxStockThreshold} is not a valid integer");
                    }
                }
            }
            ...
            if (onReorderIndex != -1)
            {
                ...
                if (!String.IsNullOrEmpty(onReorderString))
                {
                    ...
                    {
                        throw new System.Exception($"onReorder={onReorderString} is not a valid boolean");
                    }
                }
            }
        ...
        private string[] GetHeaders(string csvfile, string[] requiredHeaders, string[] optionalHeaders = null)
        {
            ...
            {
                throw new System.Exception($"requiredHeader count '{ requiredHeaders.Count()}' is bigger then csv header count '{csvheaders.Count()}' ");
            }
            ...
            if (optionalHeaders != null)
            {
                ...
                {
                    throw new System.Exception($"csv header count '{csvheaders.Count()}'  is larger then required '{requiredHeaders.Count()}' and optional '{optionalHeaders.Count()}' headers count");
                }
            }
            ...
            foreach (var requiredHeader in requiredHeaders)
            {
                ...
                {
                    throw new System.Exception($"does not contain required header '{requiredHeader}'");
                }
            }
                ...
                WaitAndRetryAsync(
                    ...
                    onRetry: (exception, timeSpan, retry, ctx) =>
                    {
                        logger.LogWarning(
                            ...
                            , exception.Message, retry, retries);
                    }
                );
        }
