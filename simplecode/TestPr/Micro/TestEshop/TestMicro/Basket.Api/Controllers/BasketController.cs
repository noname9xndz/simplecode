...
namespace Basket.Api.Controllers
{
    ...
    public class BasketController : ControllerBase
    {
        ...
        public async Task<IActionResult> CheckoutAsync([FromBody] BasketCheckout basketCheckout, [FromHeader(Name = "x-requestid")] string requestId)
        {
            ...
            var eventMessage = new UserCheckoutAcceptedEvent(userId, userName, basketCheckout.City, basketCheckout.Street,
            ...
            {
                _logger.LogError(ex, "ERROR Publishing integration event: {IntegrationEventId} from {AppName}", eventMessage.Id, CustomProgramExtension.AppName);
