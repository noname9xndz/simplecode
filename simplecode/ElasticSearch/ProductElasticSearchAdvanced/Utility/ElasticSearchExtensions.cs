...
namespace ProductElasticSearchAdvanced.Utility
{
    public static class ElasticSearchExtensions
    {
        ...
        private static void AddDefaultMappings(ConnectionSettings settings)
        {
            ...
            settings.DefaultMappingFor<Brand>(m => m.Ignore(p => p.Description));

            settings.DefaultMappingFor<Category>(m => m.Ignore(p => p.Description));

            settings.DefaultMappingFor<Store>(m => m.Ignore(p => p.Description));

            settings.DefaultMappingFor<User>(m => m
